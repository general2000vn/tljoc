        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php
                    echo $this->Form->control('start_date', ['empty' => true, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-6']]);
                    echo $this->Form->control('end_date', ['empty' => true, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-6']]);
                    echo $this->Form->control('content', ['type' => 'text', 'disabled', 'templateVars' => ['ctnClass' => 'col-md-12']]);
