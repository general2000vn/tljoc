        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    echo $this->Form->control('departments._ids', ['label' => 'Distributed To', 'options' => $doc_in_depts, 'multiple', 'data-placeholder' => "Pick one or more Departments", 'templateVars' => [ 'lblClass' => 'required', 'extra_class' => 'select2', 'ctnClass' => 'col-md-12']]);
