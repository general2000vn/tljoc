    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <?php
                    echo $this->Form->control('reg_date', [ 'label' => 'Registration Date', 'required', 'templateVars' => ['lblClass' => 'required', 'ctnClass' => 'col-md-3']]);
                    echo $this->Form->control('reg_num', [ 'label' => 'Document Number', 'required', 'templateVars' => ['lblClass' => 'required', 'ctnClass' => 'col-md-3']]);
                    ...
                    echo $this->Form->control('partner_id', ['label' => 'Sender', 'required', 'templateVars' => [ 'lblClass' => 'required', 'extra_class' => 'select2-show-search form-select selectPartner', 'ctnClass' => 'col-md-6']]);
                    ...
                    echo $this->Form->control('departments._ids', ['label' => 'Distributed To', 'options' => $doc_in_depts, 'multiple', 'data-placeholder' => "Pick one or more Departments", 'templateVars' => [ 'lblClass' => 'required', 'extra_class' => 'select2-show-search form-select', 'ctnClass' => 'col-md-12']]);
