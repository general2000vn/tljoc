...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Doc Sec Level'), ['action' => 'edit', $docSecLevel->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Doc Sec Level'), ['action' => 'delete', $docSecLevel->id], ['confirm' => __('Are you sure you want to delete # {0}?', $docSecLevel->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Doc Sec Levels'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Doc Sec Level'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="docSecLevels view content">
            <h3><?= h($docSecLevel->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($docSecLevel->doc_incomings)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($docSecLevel->doc_incomings as $docIncomings) : ?>
                        <tr>
