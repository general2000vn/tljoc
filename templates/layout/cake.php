        ...
        <div class="top-nav-links">
            <?php
                if ($this->Identity->isLoggedIn()) {
                    ...
                    echo $this->Html->link('Timesheets', ['controller'=>'Timesheets', 'action'=>'index']);
                    echo $this->Html->link('Roles', ['controller'=>'Roles', 'action'=>'index']);
                    echo $this->Html->link('Departments', ['controller'=>'Departments', 'action'=>'index']);
                } else {
