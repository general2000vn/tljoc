        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    echo $this->Form->control('search_text', ['class' => 'form-control', 'label' => 'Contain', 'value' => $criteria['search_text'], 'placeholder' => 'search by: Document Number, Subject, Contract Number, Attachment name ...','templateVars' => ['ctnClass' => 'col-md-6']]);
