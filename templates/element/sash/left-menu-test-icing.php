...
----------END - template----------- */
    ...
    $menu->addChild('e-Offce', ['templates' => ['item' => '<li class="sub-category"><h3>hjghjgh{{item}}</h3></li>']]); //separeter

    $menu->addChild('Home', [
        'uri' => 'javascript:void(0)', 'templateVars' => ['link_extra_class' => 'has-link', 'icon' => 'fe fe-home']
    ]);

    $menu->addChild('HR', ['templates' => ['item' => '<li class="sub-category"><h3>{{label}}</h3></li>']]); //separeter

    $menu->addChild('Pre-Termination', [
        'uri' => 'javascript:void(0)', 'templateVars' => ['icon' => 'fe fe-layers']
    ]);

    $menu['Pre-Termination']->addChild(
        'Create New',
        [
    ...
    $menu->addChild('Business Compliance', [
        'uri' => 'javascript:void(0)', 'templateVars' => ['icon' => 'fe fe-layers']
    ]);


    $menu['Business Compliance']->addChild(
        'Create Campaign',
        [
