...
<?php
$page_heading = 'Department Daily WFH Record: ' . $criteria['view_date'] . ' ' . $group->name;
...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="body">
                <?= $this->Form->create(null, ['method' => 'POST', 'url' => ['action' => 'deptDaily']]) ?>
                <div class="row clearfix">
                    ...
                    <div class="col-md-4  form-group">
                        <?= $this->Form->select('department_id', ['Department' => $department], ['default' => $department->id, 'caption' => 'Department', 'class' => 'form-control ']) ?>
                    </div>
                    ...
                    <table class="table js-exportable table-bordered c_table table-hover table-striped dataTable  theme-color">
                        ...
                        <tbody>
                            ...
                            foreach ($timesheets as $timesheet) {
                                ...
                                //echo '<td>' . $this->Html->link($timesheet->start_date->format('Y-m-d D') . ' ' . ($timesheet->has('start_time') ? $timesheet->start_time : ""), ['controller' => 'Timesheets', 'action' => 'view', $timesheet->id]) . '</td>';
