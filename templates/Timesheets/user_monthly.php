...
<?php
$page_heading = 'Monthly: ' . $criteria['year'] . ' - ' . $criteria['month'] . ' ' . $user->name;
...
$this->set('breadcrumbs', [
    ...
    ['caption' => $user->name, 'class' => 'active'],
]);
            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-md-4 form-group">
                        <?= $this->Form->control('year', ['type' => 'number', 'value' => $criteria['year'], 'min' => $criteria['year'] - 5, 'class' => 'form-control']) ?>
                    </div>
