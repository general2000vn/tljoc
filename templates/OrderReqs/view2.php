        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    echo $this->Form->control('department_id', ['type' => 'text', 'label' => 'Dept.', 'value' => $curDept->init, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-1']]);
                    echo $this->Form->control('req_num', ['label' => 'OR Number', 'disabled', 'templateVars' => ['ctnClass' => 'col-md-2']]);
                    echo '<div class="col-md-3"><div class="row">';
                    echo $this->Form->control('submit_date', ['disabled', 'placeholder' => '', 'templateVars' => ['ctnClass' => 'col-md-6']]);
                    echo $this->Form->control('required_date', ['empty' => true, 'disabled', 'label' => 'Required Date', 'templateVars' => ['ctnClass' => 'col-md-6']]);
                    echo '</div></div>';
                    echo $this->Form->control('contract_num', ['empty' => true, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-2']]);
                    echo $this->Form->control('budget_code', ['empty' => true, 'label' => 'Budget', 'disabled', 'templateVars' => ['ctnClass' => 'col-md-1']]);
                    echo $this->Form->control('currency_id', ['options' => $currencies, 'disabled', 'empty' => false, 'templateVars' => ['extra_class' => 'form-select select2', 'ctnClass' => 'col-md-1']]);
                    echo $this->Form->control('originator_id', ['type' => 'text', 'value' => 'Huong Nguyen Thi Thu', 'disabled', 'templateVars' => ['ctnClass' => 'col-md-2']]);
                    ...
                    echo $this->Form->control('doc_company_id', ['label' => 'Company', 'options' => $docCompanies, 'disabled', 'templateVars' => ['extra_class' => 'form-select select2', 'ctnClass' => 'col-md-1']]);
                    echo $this->Form->control('cp_method_id', ['options' => $cpMethods, 'label' => 'Procurement Mode', 'disabled', 'empty' => false, 'templateVars' => ['extra_class' => 'form-select select2', 'ctnClass' => 'col-md-2']]);
                    echo $this->Form->control('est_total', ['label' => 'Cost Estimation',  'empty' => true, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-3']]);
                    echo $this->Form->control('exch_rate', ['label' => 'Exchange Rate', 'disabled', 'empty' => true, 'templateVars' => ['ctnClass' => 'col-md-2']]);
                    echo $this->Form->control('deli_address_id', ['label' => 'Delivery Address', 'disabled', 'options' => $deliAddresses, 'empty' => false, 'templateVars' => ['extra_class' => 'form-select select2', 'ctnClass' => 'col-md-2']]);
                    ?>
