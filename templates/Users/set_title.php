...
$page_heading = 'Set Employees Title';
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    echo $this->Form->control('title', ['type' => 'select', 'options' => ['Mr.' => 'Mr.', 'Ms.' => 'Ms.', 'Dr.' => 'Dr.'], 'label' => 'Employee Title', 'templateVars' => ['ctnClass' => 'col-md-12']]);
