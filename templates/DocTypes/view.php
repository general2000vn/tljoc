...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Doc Type'), ['action' => 'edit', $docType->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Doc Type'), ['action' => 'delete', $docType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $docType->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Doc Types'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Doc Type'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="docTypes view content">
            <h3><?= h($docType->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
                    <td><?= h($docType->name) ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($docType->doc_incomings)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($docType->doc_incomings as $docIncomings) : ?>
                        <tr>
