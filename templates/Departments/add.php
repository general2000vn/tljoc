        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    echo $this->Form->control('deputies._ids',  ['options' => $users, 'empty' => true, 'label' => 'Deputy Line Manager', 'templateVars' => ['extra_class' => 'select2-show-search form-select', 'ctnClass' => 'col-md-4']]);
