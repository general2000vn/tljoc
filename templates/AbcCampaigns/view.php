...
$page_heading = 'View Campaign detail';
                            ...
                            <?php foreach ($questions as $question) : ?>
                                <?php if ($question->abc_category_id == $category->id) : ?>
                                    ...
                                    <div class="row" id="item-<?= $i ?>-">
                                        ...
                                        <div class="col-md-2">
                                            <div class="row">
                                                <?= $this->Form->control('abc_questions.' . $i . '.order_code', ['label' => false, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-12']]) ?>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="form-label">Abnormal Answer</div>
                                                    <?= $this->Form->radio('abc_questions.' . $i . '.abnormal', ['No', 'Yes'], ['disabled', 'class' => 'custom-control-input', 'templateVars' => ['ctnClass' => 'custom-control custom-radio-md']]) ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                <?= $this->Form->control('abc_questions.' . $i . '.vn', ['disabled', 'label' => false, 'rows' => 3,  'templateVars' => ['ctnClass' => 'col-md-12']]) ?>
                                                <?= $this->Form->control('abc_questions.' . $i . '.en', ['disabled', 'label' => false, 'rows' => 3,  'templateVars' => ['ctnClass' => 'col-md-12']]) ?>
                                            </div>
                                        </div>
                                        <?php $i++; ?>
                                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-footer mt-2 text-center">
                        ...
                        <?php if ($abcCampaign->abc_status_id == AbcStatusesTable::S_DRAFT) : ?>
                            <?= $this->Html->link(__('Edit'), ['action' => 'edit', $abcCampaign->id ], ['class' => 'btn btn-large btn-primary']) ?>
                            <?= $this->Html->link(__('Publish'), ['action' => 'publish', $abcCampaign->id ], ['class' => 'btn btn-large btn-secondary']) ?>
                        <?php elseif ($abcCampaign->abc_status_id == AbcStatusesTable::S_PROCESSING) : ?>
                            <?= $this->Html->link(__('Statistic'), ['action' => 'stat', $abcCampaign->id ], ['class' => 'btn btn-large btn-primary']) ?>
