...
$page_heading = 'Reserve Internal Document';
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php
                    echo $this->Form->control('reg_date', ['label' => 'Registration Date', 'value' => FrozenDate::today(), 'required', 'templateVars' => ['lblClass' => 'required', 'ctnClass' => 'col-md-3']]);
