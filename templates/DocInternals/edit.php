        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    echo $this->Form->control('inputter_id', ['options' => $users, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-6']]);
                    ...
                    echo $this->Form->control('department_id', ['label' => 'Department', 'required',  'templateVars' => ['lblClass' => 'required', 'ctnClass' => 'col-md-4']]);
                    echo $this->Form->control('originator_id', ['options' => $users, 'label' => 'Originator', 'required', 'empty' => true,'data-placeholder' => "Select a staff", 'templateVars' => ['lblClass' => 'required', 'extra_class' => 'select2-show-search form-select', 'ctnClass' => 'col-md-4']]);
