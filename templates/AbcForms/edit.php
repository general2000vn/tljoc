...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row"><p>If you answer ‘NO’ to the questions 1.1, 1.2, 2.4, 4.8, 7.2, 8.1 and 9.1, or ‘YES’ to any of the other questions, please provide details in the next page for review and evaluation of the circumstances</p></div>
                <div class="row">
                    <?php
                    
                    echo $this->Form->control('justification', [ 'label' => '','rows' => 4 ,  'templateVars' => ['ctnClass' => 'col-md-12']]);
