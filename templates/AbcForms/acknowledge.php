...
$page_heading = 'Acknowledge Annual Business Compliance form';
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    echo $this->Form->control('handler_id', ['label' => 'Acknowledge by', 'value' => null, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-3']]);
                    echo $this->Form->control('ack_date', ['label' => 'Acknowledge time', 'value' => null, 'disabled', 'templateVars' => ['ctnClass' => 'col-md-3']]);
                    ?>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                        ...
                        <?= $this->Form->control('feedback', ['templateVars' => ['ctnClass' => 'col-12']]) ?>
                    
                </div>
                <div class="row">
                    <div class="form-footer mt-2 text-center">
                        <?= $this->Form->button(__('Acknowledge'), ['name' => 'btnAck','templateVars' => ['extra_class' => 'btn-info']]) ?>
                        <?= $this->Form->button(__('Reject'), ['name' => 'btnReject','templateVars' => ['extra_class' => 'btn-danger']]) ?>
                        <?= $this->Html->link(__('Back'), ['action' => 'myAck'],['class' => 'btn btn-medium btn-primary']) ?>
                    </div>
                </div>
            </div>
        </div>
