 ...
 */
$page_heading = 'Edit PRD Yearly Target';
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Yearly Target</h3>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    echo $this->Form->control('target_year', ['empty' => true, 'type' => 'year','label' => 'Year', 'required', 'templateVars' => ['ctnClass' => 'col-md-4']]);
