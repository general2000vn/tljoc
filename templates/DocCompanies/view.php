...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Doc Company'), ['action' => 'edit', $docCompany->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Doc Company'), ['action' => 'delete', $docCompany->id], ['confirm' => __('Are you sure you want to delete # {0}?', $docCompany->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Doc Companies'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Doc Company'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="docCompanies view content">
            <h3><?= h($docCompany->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($docCompany->doc_incomings)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($docCompany->doc_incomings as $docIncomings) : ?>
                        <tr>
