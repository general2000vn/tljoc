        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    echo $this->Form->control('users._ids', ['options' => $users, 'label' => 'Assign Users', 'multiple', 'templateVars' => ['extra_class' => 'select2-show-search form-select', 'ctnClass' => 'col-md-12']]);
