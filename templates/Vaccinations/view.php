...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Vaccination'), ['action' => 'edit', $vaccination->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Vaccination'), ['action' => 'delete', $vaccination->id], ['confirm' => __('Are you sure you want to delete # {0}?', $vaccination->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Vaccinations'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Vaccination'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="vaccinations view content">
            <h3><?= h($vaccination->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
                    <td><?= h($vaccination->name) ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($vaccination->timesheets)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($vaccination->timesheets as $timesheets) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <?php if (!empty($vaccination->users)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($vaccination->users as $users) : ?>
                        <tr>
                            <td><?= h($users->id) ?></td>
