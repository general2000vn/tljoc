        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php
                    echo $this->Form->control('reg_date', ['label' => 'Registration Date', 'value' => FrozenDate::today(),'class' => 'form-control', 'disabled', 'templateVars' => ['ctnClass' => 'col-md-3']]);
                    echo $this->Form->control('reg_num', ['label' => 'Document Number', 'class' => 'form-control', 'disabled', 'templateVars' => ['ctnClass' => 'col-md-3']]);
