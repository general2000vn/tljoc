...
try {
    ...
    Configure::load('LDAP', 'default');
    Configure::load('checkin', 'default');
} catch (\Exception $e) {
    exit($e->getMessage() . "\n");
}
...
if (Configure::read('debug')) {
    ...
    //load DebugKit configuration
    //$this->addPlugin(\DebugKit\Plugin::class, ['bootstrap' => true]);
    Configure::load('debug_kit');
    // Show more levels
...
// \Cake\I18n\Date::setToStringFormat('Y-MM-d'); 
// \Cake\I18n\FrozenTime::setToStringFormat('Y-MM-d HH:mm:ss');
// \Cake\I18n\FrozenDate::setToStringFormat('Y-MM-d');

\Cake\I18n\Time::setToStringFormat('HH:mm:ss');
\Cake\I18n\Date::setToStringFormat('Y-MM-dd'); 
\Cake\I18n\FrozenTime::setToStringFormat('Y-MM-dd HH:mm');
\Cake\I18n\FrozenDate::setToStringFormat('Y-MM-dd');
