...
$('document').ready(function () {
    ...
    $('#btn-add-supplier').click(function () {
        ...
        label_block += '<div class="col-md-1"> <label class="form-label" for=""></label> </div>';
        //label_block += '</div>';
    ...
    $('#btn-add-item').click(function () {
        ...
        item_block += '<div class="col-md-2"><div class="form-group"><input type="number" name="or_items[0][price]" class="form-control item_price"  data-validity-message="This field cannot be left empty" id="or-items-0-price"></div></div>';
